...
import "../../styles/ATBigTimePage.css";

const ATBigTimePage = ({ onBack, userWallet = 0 }) => {
  ...
  const atBigTimeBundles = [
    { id: 1, data: "1GB", price: 4.6, priceText: "GH₵ 4.60" },
    { id: 2, data: "2GB", price: 9.0, priceText: "GH₵ 9.00" },
    { id: 3, data: "3GB", price: 13.0, priceText: "GH₵ 13.00" },
    { id: 4, data: "4GB", price: 16.5, priceText: "GH₵ 16.50" },
    { id: 5, data: "5GB", price: 21.0, priceText: "GH₵ 21.00" },
    { id: 8, data: "10GB", price: 41.0, priceText: "GH₵ 41.00" },
    { id: 10, data: "20GB", price: 101.0, priceText: "GH₵ 101.00" },
    { id: 14, data: "50GB", price: 200.0, priceText: "GH₵ 200.00" },
  ];

  // Validate AirtelTigo Ghana number
  const validateAirtelTigoNumber = (number) => {
    // AirtelTigo Ghana prefixes: 026, 027, 056, 057 (some overlap with Telecel)
    const airtelTigoPrefixes = ["026", "027", "056"];
    const fullNumber = "0" + number;
    return (
      airtelTigoPrefixes.some((prefix) => fullNumber.startsWith(prefix)) &&
      number.length === 9
    );
  };
  ...
  const validateForm = () => {
    ...
    } else if (!validateAirtelTigoNumber(phoneNumber)) {
      newErrors.phoneNumber =
        "Please enter a valid AirtelTigo number (026, 027, 056)";
    }
  ...
  const handleConfirmPurchase = async () => {
    ...
    try {
      ...
      const txId = `AT_BIGTIME_${Date.now()}_${Math.random()
        .toString(36)
        .substr(2, 9)}`;
      ...
      if (response.success) {
        ...
        alert(
          `✅ Success!\nTransaction ID: ${txId}\n${
            selectedBundle.data
          } AT BigTime bundle sent to 0${phoneNumber}\nRemaining balance: GH₵ ${(
  ...
  return (
    <div className="at-bigtime-page">
      {/* Header with Wallet Balance */}
      <div className="at-bigtime-header">
        <button onClick={onBack} className="back-button">
          <ArrowLeft size={20} />
        </button>
        <div className="header-content">
          <div className="at-bigtime-logo">
            <Database size={24} className="at-bigtime-icon" />
          </div>
          <div className="header-text">
            <h1 className="page-title">AT BigTime Bundles</h1>
            <p className="page-subtitle">
              Massive data packages for heavy users
            </p>
          </div>
        </div>
      ...
      <div className="phone-input-section">
        ...
        <p className="input-helper">
          Enter recipient's AirtelTigo number (026, 027, 056)
        </p>
      </div>

      {/* Bundles Grid */}
      <div className="bundles-section">
        <h2 className="section-title">Available BigTime Bundles</h2>
        {errors.bundle && <p className="error-message">{errors.bundle}</p>}
        {errors.wallet && (
          <p className="error-message wallet-error">{errors.wallet}</p>
        )}
        <div className="bundles-grid">
          {atBigTimeBundles.map((bundle) => {
              ...
              >
                ...
                <div className="bundle-content">
                  <div className="bundle-data">
                    ...
                    <span className="bundle-type">BigTime</span>
                  </div>
          ...
          <div className="summary-content">
            <div className="summary-details">
              ...
              <div className="summary-row">
                <span>Bundle:</span>
                <span>{selectedBundle.data} BigTime</span>
              </div>
              <div className="summary-row">
            ...
            <div className="modal-content">
              ...
              <div className="confirmation-details">
                <div className="detail-row">
                  <span>Bundle:</span>
                  <strong>{selectedBundle.data} BigTime</strong>
                </div>
                <div className="detail-row">
                  <span>Phone:</span>
